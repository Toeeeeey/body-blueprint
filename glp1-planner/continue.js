...
function resetContinuationPage(){
  ...
  reviewRows=[];continuationRows=[];continuationMeta=null;continueWasCleared=true;
  $('#reviewText').value='';$('#usedThrough').innerHTML='';$('#priorUsedClicks').value='0';$('#reviewSummary').innerHTML='';$('#reviewHistoryBody').innerHTML='';$('#continueResultSummary').innerHTML='';$('#continuePatientText').textContent='';
